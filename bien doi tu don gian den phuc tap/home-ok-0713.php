...
$tv="select id, hinh_anh, tour_name,plan_id,noi_dung,M_PLACE_to_place_id,div_2,fee_min,fee_max from san_pham where level = '997' order by id desc limit 10";
$tv_1= mysql_query($tv);
while ($tv_2=mysql_fetch_array($tv_1))
